...
WEBP_EXTERN(int) WebPEncodeAsync(const WebPConfig* config, WebPPicture** picture);
WEBP_EXTERN(int) WebPEncodeAsync_k1(const WebPConfig* config, WebPPicture** picture);
//------------------------------------------------------------------------------
