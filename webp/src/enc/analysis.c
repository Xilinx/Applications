...
int VP8EncAnalyzeOcl(VP8Encoder* const enc) {
  ...
  if (do_segments) {
    ...
    if (expand_yheight > height) {
      err = clEnqueueWriteBuffer(hardware.mQueue, analyzepara.y, CL_TRUE, y_size, expand_y_size, expand_y, 0, NULL, NULL);
      if(CL_SUCCESS != err) {
        fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
        ok = 0;
        goto Err;
    ...
    if (expand_uvheight > uv_height) {
      err = clEnqueueWriteBuffer(hardware.mQueue, analyzepara.u, CL_TRUE, u_size, expand_uv_size, expand_u, 0, NULL, NULL);
      if(CL_SUCCESS != err) {
        fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
        ok = 0;
        goto Err;
    ...
    if (expand_uvheight > uv_height) {
      err = clEnqueueWriteBuffer(hardware.mQueue, analyzepara.v, CL_TRUE, v_size, expand_uv_size, expand_v, 0, NULL, NULL);
      if(CL_SUCCESS != err) {
        fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
        ok = 0;
        goto Err;
    ...
    err = clEnqueueWriteBuffer(hardware.mQueue, analyzepara.output_alpha, CL_TRUE, 0, mb_h * sizeof(int), &output_alpha, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
    ...
    err = clEnqueueWriteBuffer(hardware.mQueue, analyzepara.output_uvalpha, CL_TRUE, 0, mb_h * sizeof(int), &output_uvalpha, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
    ...
    err = clEnqueueWriteBuffer(hardware.mQueue, analyzepara.alphas, CL_TRUE, 0, mb_h * (MAX_ALPHA + 1) * sizeof(int), alphas, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
    ...
    err = clEnqueueNDRangeKernel(hardware.mQueue, analyze.mKernel, 2, 0,
    ...
    err = clEnqueueReadBuffer(hardware.mQueue, analyzepara.output_alpha, CL_TRUE, 0, mb_h * sizeof(int), &output_alpha, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
    ...
    err = clEnqueueReadBuffer(hardware.mQueue, analyzepara.output_uvalpha, CL_TRUE, 0, mb_h * sizeof(int), &output_uvalpha, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
    ...
    err = clEnqueueReadBuffer(hardware.mQueue, analyzepara.mb_info, CL_TRUE, 0, 3 * mb_size, mb_info, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
    ...
    err = clEnqueueReadBuffer(hardware.mQueue, analyzepara.preds, CL_TRUE, 0, preds_size, enc->preds_, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
    ...
    err = clEnqueueReadBuffer(hardware.mQueue, analyzepara.alphas, CL_TRUE, 0, mb_h * (MAX_ALPHA + 1) * sizeof(int), alphas, 0, NULL, NULL);
    if(CL_SUCCESS != err) {
      fprintf(stderr, "%s %d %s\n", __func__, __LINE__, oclErrorCode(err));
      ok = 0;
      goto Err;
