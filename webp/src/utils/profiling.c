...
void DisplayDecodeProfilingResult() {
  if (0 != countWebPDecode) {
    fprintf(stderr, "WebPDecode Total Time: %.6f ms, count:%d, average time: %.6f ms\n",
            timeWebPDecode, countWebPDecode, timeWebPDecode / countWebPDecode);
  }
  ...
  if (0 != countVP8ParseIntraModeRow) {
    fprintf(stderr, "      VP8ParseIntraModeRow Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8ParseIntraModeRow, countVP8ParseIntraModeRow, timeVP8ParseIntraModeRow / countVP8ParseIntraModeRow,
            timeVP8ParseIntraModeRow * 100 / timeWebPDecode);
  }
  ...
  if (0 != countParseResiduals) {
    fprintf(stderr, "        ParseResiduals Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countVP8TransformWHT) {
    fprintf(stderr, "          VP8TransformWHT Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countGetCoeffs) {
    fprintf(stderr, "          GetCoeffs Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timeGetCoeffs, countGetCoeffs, timeGetCoeffs / countGetCoeffs,
            timeGetCoeffs * 100 / timeWebPDecode);
  }
  if (0 != countParseResidualsIf1) {
    fprintf(stderr, "          ParseResidualsIf1 Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countParseResidualsLoop1) {
    fprintf(stderr, "          ParseResidualsLoop1 Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countParseResidualsLoop2) {
    fprintf(stderr, "          ParseResidualsLoop2 Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countReconstructRow) {
    fprintf(stderr, "        ReconstructRow Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countFinishRow) {
    fprintf(stderr, "        FinishRow Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timeFinishRow, countFinishRow, timeFinishRow / countFinishRow,
            timeFinishRow * 100 / timeWebPDecode);
  }
  // lossy end
  ...
  if (0 != countApplyInverseTransforms) {
    fprintf(stderr, "        ApplyInverseTransforms Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timeApplyInverseTransforms, countApplyInverseTransforms, timeApplyInverseTransforms / countApplyInverseTransforms,
            timeApplyInverseTransforms * 100 / timeWebPDecode);
  }
  if (0 != countProcessRowsCopy1) {
    fprintf(stderr, "          ProcessRowsCopy1 Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countVP8LAddGreenToBlueAndRed) {
    fprintf(stderr, "          VP8LAddGreenToBlueAndRed Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8LAddGreenToBlueAndRed, countVP8LAddGreenToBlueAndRed, timeVP8LAddGreenToBlueAndRed / countVP8LAddGreenToBlueAndRed,
            timeVP8LAddGreenToBlueAndRed * 100 / timeWebPDecode);
  }
  if (0 != countColorSpaceInverseTransform) {
    fprintf(stderr, "          ColorSpaceInverseTransform Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timeColorSpaceInverseTransform, countColorSpaceInverseTransform, timeColorSpaceInverseTransform / countColorSpaceInverseTransform,
            timeColorSpaceInverseTransform * 100 / timeWebPDecode);
  }
  if (0 != countPredictorInverseTransform) {
    fprintf(stderr, "          PredictorInverseTransform Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timePredictorInverseTransform, countPredictorInverseTransform, timePredictorInverseTransform / countPredictorInverseTransform,
            timePredictorInverseTransform * 100 / timeWebPDecode);
  }
  if (0 != countProcessRowsCopy2) {
    fprintf(stderr, "          ProcessRowsCopy2 Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countColorIndexInverseTransform) {
    fprintf(stderr, "        ColorIndexInverseTransform Total Time: %.6f ms, count:%d, average time: %.6f ms, percentage:%.6f%\n",
            timeColorIndexInverseTransform, countColorIndexInverseTransform, timeColorIndexInverseTransform / countColorIndexInverseTransform,
...
void DisplayEncodeProfilingResult() {
  ...
  if (0 != countWebPEncode) {
    fprintf(stderr, "WebPEncode Total Time: %.6f ms, count:%d, average time: %.6f ms\n",
            timeWebPEncode, countWebPEncode, timeWebPEncode / countWebPEncode);
  }
  if (0 != countApplyTransforms) {
    fprintf(stderr, "lossless encode.......\n");
    fprintf(stderr, "  ApplyTransforms\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeApplyTransforms, countApplyTransforms, timeApplyTransforms / countApplyTransforms, timeApplyTransforms * 100 / timeWebPEncode);
  }
  if (0 != timeVP8ApplyNearLossless) {
    fprintf(stderr, "    VP8ApplyNearLossless\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8ApplyNearLossless, countVP8ApplyNearLossless, timeVP8ApplyNearLossless / countVP8ApplyNearLossless, timeVP8ApplyNearLossless * 100 / timeWebPEncode);
  }
  if (0 != timeVP8ApplyNearLosslessOcl) {
    fprintf(stderr, "    VP8ApplyNearLosslessOcl\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8ApplyNearLosslessOcl, countVP8ApplyNearLosslessOcl, timeVP8ApplyNearLosslessOcl / countVP8ApplyNearLosslessOcl, timeVP8ApplyNearLosslessOcl * 100 / timeWebPEncode);
  }
  if (0 != countApplySubtractGreen) {
    fprintf(stderr, "    ApplySubtractGreen\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeApplySubtractGreen, countApplySubtractGreen, timeApplySubtractGreen / countApplySubtractGreen, timeApplySubtractGreen * 100 / timeWebPEncode);
  }
  if (0 != countEncPredict) {
    fprintf(stderr, "    ApplyPredictFilter\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeEncPredict, countEncPredict, timeEncPredict / countEncPredict, timeEncPredict * 100 / timeWebPEncode);
  }
  if (0 != countVP8LResidualImage) {
    fprintf(stderr, "      VP8LResidualImage\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8LResidualImage, countVP8LResidualImage, timeVP8LResidualImage / countVP8LResidualImage, timeVP8LResidualImage * 100 / timeWebPEncode);
  }
  if (0 != countBestPredict) {
    fprintf(stderr, "        GetBestPredictorForTile\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeBestPredict, countBestPredict, timeBestPredict / countBestPredict, timeBestPredict * 100 / timeWebPEncode);
  }
  if (0 != countGetPredModesResiduleForTile) {
    fprintf(stderr, "        GetPredModesResiduleForTile Total Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeGetPredModesResiduleForTile, countGetPredModesResiduleForTile, timeGetPredModesResiduleForTile / countGetPredModesResiduleForTile, timeGetPredModesResiduleForTile * 100 / timeWebPEncode);
  }
  if (0 != countGetBestPredictorForTile2) {
    fprintf(stderr, "        GetBestPredictorForTile2\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeGetBestPredictorForTile2, countGetBestPredictorForTile2, timeGetBestPredictorForTile2 / countGetBestPredictorForTile2, timeGetBestPredictorForTile2 * 100 / timeWebPEncode);
  }
  if (0 != countEncColorFilt) {
    fprintf(stderr, "    ApplyCrossColorFilter\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeEncColorFilt, countEncColorFilt, timeEncColorFilt / countEncColorFilt, timeEncColorFilt * 100 / timeWebPEncode);
  }
  if (0 != countBestColor) {
    fprintf(stderr, "      GetBestColorTransformForTileTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeBestColor, countBestColor, timeBestColor / countBestColor, timeBestColor * 100 / timeWebPEncode);
  }
  if (0 != countGetBackRef) {
    fprintf(stderr, "  GetBackwardReferences\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeGetBackRef, countGetBackRef, timeGetBackRef / countGetBackRef, timeGetBackRef * 100 / timeWebPEncode);
  }
  if (0 != countBackwardRefLz77) {
    fprintf(stderr, "    BackwardReferencesLz77\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeBackwardRefLz77, countBackwardRefLz77, timeBackwardRefLz77 / countBackwardRefLz77, timeBackwardRefLz77 * 100 / timeWebPEncode);
  }
  if (0 != countBackwardRefRle) {
    fprintf(stderr, "    BackwardReferencesRle\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeBackwardRefRle, countBackwardRefRle, timeBackwardRefRle / countBackwardRefRle, timeBackwardRefRle * 100 / timeWebPEncode);
  }
  if (0 != countGetHistoImg) {
    fprintf(stderr, "  VP8LGetHistoImageSymbols\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeGetHistoImg, countGetHistoImg, timeGetHistoImg / countGetHistoImg, timeGetHistoImg * 100 / timeWebPEncode);
  }
  if (0 != countHistogramCombineStochastic) {
    fprintf(stderr, "    HistogramCombineStochastic\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeHistogramCombineStochastic, countHistogramCombineStochastic, timeHistogramCombineStochastic / countHistogramCombineStochastic, timeHistogramCombineStochastic * 100 / timeWebPEncode);
  }
  if (0 != countHistogramCombineStochastic_forloop) {
    fprintf(stderr, "    HistogramCombineStochastic_forloop\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeHistogramCombineStochastic_forloop, countHistogramCombineStochastic_forloop, timeHistogramCombineStochastic_forloop / countHistogramCombineStochastic_forloop, timeHistogramCombineStochastic_forloop * 100 / timeWebPEncode);
  }
  if (0 != countHistogramAddEval) {
    fprintf(stderr, "      HistogramAddEval\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeHistogramAddEval, countHistogramAddEval, timeHistogramAddEval / countHistogramAddEval, timeHistogramAddEval * 100 / timeWebPEncode);
  }
  if (0 != countHistogramRemap) {
    fprintf(stderr, "    HistogramRemap\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeHistogramRemap, countHistogramRemap, timeHistogramRemap / countHistogramRemap, timeHistogramRemap * 100 / timeWebPEncode);
  }
  if (0 != countEncode) {
  ...
  if (0 != countEncAnalyze) {
    ...
    fprintf(stderr, "  VP8EncAnalyze\t\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeEncAnalyze, countEncAnalyze, timeEncAnalyze / countEncAnalyze, timeEncAnalyze * 100 / timeWebPEncode);
  }
  if (0 != countEncAnalyzeOcl) {
    fprintf(stderr, "lossy encode.......\n");
    fprintf(stderr, "  VP8EncAnalyzeOcl\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeEncAnalyzeOcl, countEncAnalyzeOcl, timeEncAnalyzeOcl / countEncAnalyzeOcl, timeEncAnalyzeOcl * 100 / timeWebPEncode);
  }
  if (0 != countEncTokenLoop) {
    fprintf(stderr, "  VP8EncTokenLoop\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeEncTokenLoop, countEncTokenLoop, timeEncTokenLoop / countEncTokenLoop, timeEncTokenLoop * 100 / timeWebPEncode);
  }
  if (0 != countEncLoop) {
  ...
  if (0 != countEncLoopOcl) {
    fprintf(stderr, "  VP8EncLoopOcl\t\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countVP8Decimate_2 && 0 != countEncLoop) {
    fprintf(stderr, "      VP8Decimate\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8Decimate_2, countVP8Decimate_2, timeVP8Decimate_2 / countVP8Decimate_2, timeVP8Decimate_2 * 100 / timeWebPEncode);
  } else if(0 != countVP8Decimate_2) {
    fprintf(stderr, "    VP8Decimate\t\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8Decimate_2, countVP8Decimate_2, timeVP8Decimate_2 / countVP8Decimate_2, timeVP8Decimate_2 * 100 / timeWebPEncode);
  }
  if (0 != countRefineUsingDist) {
    fprintf(stderr, "        RefineUsingDistortion\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeRefineUsingDist_2, countRefineUsingDist_2, timeRefineUsingDist_2 / countRefineUsingDist_2, timeRefineUsingDist_2 * 100 / timeWebPEncode);
  }
  if (0 != countStoreFilterSts) {
    fprintf(stderr, "    VP8StoreFilterStats\t\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeStoreFilterSts, countStoreFilterSts, timeStoreFilterSts / countStoreFilterSts, timeStoreFilterSts * 100 / timeWebPEncode);
  }
  if (0 != countCodeResiduals) {
    fprintf(stderr, "    CodeResiduals\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeCodeResiduals, countCodeResiduals, timeCodeResiduals / countCodeResiduals, timeCodeResiduals * 100 / timeWebPEncode);
  }
  if (0 != countVP8Decimate) {
    fprintf(stderr, "    VP8Decimate\t\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8Decimate, countVP8Decimate, timeVP8Decimate / countVP8Decimate, timeVP8Decimate * 100 / timeWebPEncode);
  }
  if (0 != countRefineUsingDist) {
    fprintf(stderr, "      RefineUsingDistortion\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeRefineUsingDist, countRefineUsingDist, timeRefineUsingDist / countRefineUsingDist, timeRefineUsingDist * 100 / timeWebPEncode);
  }
  if (0 != countBestIntra16) {
    fprintf(stderr, "      PickBestIntra16\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeBestIntra16, countBestIntra16, timeBestIntra16 / countBestIntra16, timeBestIntra16 * 100 / timeWebPEncode);
  }
  if (0 != countBestIntra4) {
    fprintf(stderr, "      PickBestIntra4\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
  ...
  if (0 != countVP8EmitTokens) {
    fprintf(stderr, "    VP8EmitTokens\t\tTotal Time: %.6f ms, count:%6d, average time: %.6f ms, percentage:%.6f%\n",
            timeVP8EmitTokens, countVP8EmitTokens, timeVP8EmitTokens / countVP8EmitTokens, timeVP8EmitTokens * 100 / timeWebPEncode);
  }
}
