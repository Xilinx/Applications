...
typedef struct EncLoopPara {
  ...
  cl_mem output_prob;         // Output of new kernel-1, used for probability table passed to kernel-2, also used for enc->prob_.coeff_
  cl_mem output_bw;           // Output of kernel-2, used for AC
  cl_mem output_ret;          // Output of kernel-2, used for propagating return-value from Intra-prediction of kernel-1 hided in pout_level
  cl_mem output_pred;         // Output of kernel-2 used for propagating return-value from  Intra-prediction of kernel-1 hided in pout_level
